...
const Contact = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await fetch("/data/page-data.json"); // adjust path if needed
  ...
  return (
    <section
      className="no-print bg-cover bg-center bg-no-repeat"
      style={{ backgroundImage:"public\images\home\about-me\about-banner-img.svg" }} // your background image
    >
                ...
                {submitted && (
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-secondary">
                      Great! Form has been submitted (no email sent).
                    </p>
                  </div>
                )}
