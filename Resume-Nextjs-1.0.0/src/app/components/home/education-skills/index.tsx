...
const EducationSkills = () => {
  ...
  return (
    <section className="relative">
      ...
      <div className="relative border-t border-softGray overflow-hidden z-10">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-10 xl:gap-20">
              ...
              <div className="grid grid-cols-2 xs:grid-cols-3 gap-5 xl:gap-7 w-full">
                {educationData?.skills?.map((value: any, index: number) => (
                  <div
                    key={index}
                    className="p-4 xl:p-6 border border-softGray rounded-lg flex flex-col gap-5 sm:gap-10 items-center justify-between bg-white/70 backdrop-blur-sm"
                  >
